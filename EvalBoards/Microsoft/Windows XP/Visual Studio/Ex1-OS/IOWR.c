...
void update_led_display(int ledr_flag)
{
	...
	/*=======================================================================================================
	Feel free to edit here for LEDR
	This section prints out the LEDR displays
	You can call the SetColor(integer); prototype to change the colour of the display
	=======================================================================================================*/
	if (ledr_flag)
	{
		// LEDR
